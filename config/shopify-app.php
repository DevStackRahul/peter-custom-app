...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,write_script_tags,read_orders,write_orders,read_themes,write_themes'),
    ...
    */
    ...
    'webhooks' => [
            ...
            [
                ...
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://tagsapp.petsidtags.com/webhook/orders-create')
            ],

             [
                'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'THEMES_PUBLISH'),
                'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://tagsapp.petsidtags.com/webhook/theme-publish')
            ],

            [
                'topic' => env('SHOPIFY_WEBHOOK_3_TOPIC', 'APP_UNINSTALLED'),
                'address' => env('SHOPIFY_WEBHOOK_3_ADDRESS', 'https://tagsapp.petsidtags.com/webhook/app-uninstalled')
            ]
    ],
